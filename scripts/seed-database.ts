...
// Events data from data1.json, data2.json, data3.json
const eventsData = [
  // Day 1 (April 10)
...
// Team members from coreTeam.json
const teamMembersData = [
  ...
  { name: "Nachos", designation: "Core Team Coding", imageUrl: "/images/CoreTeam/Coding_Committee/Core/Nachos.webp", department: "Coding", order: 13 },
  { name: "Rutwik Dhale", designation: "Core Team Coding", imageUrl: "/images/CoreTeam/Coding_Committee/Core/Rutwik_Dhale.webp", department: "Coding", order: 14 },
  { name: "Pankaj Mandal", designation: "Core Team Coding", imageUrl: "/images/CoreTeam/Coding_Committee/Core/Pankaj_Mandal.webp", department: "Coding", order: 15 },
  { name: "Jeet Soni", designation: "Robotics Head", imageUrl: "/images/CoreTeam/Robotics_committee/CORE/Jeet_head.webp", department: "Robotics", order: 16 },
  { name: "Prashant", designation: "Robotics Head", imageUrl: "/images/CoreTeam/Robotics_committee/CORE/Prashant_head.webp", department: "Robotics", order: 17 },
  { name: "Danish Ansari", designation: "Sports Head", imageUrl: "/images/CoreTeam/Sports_committee/Danish_Ansari_head.webp", department: "Sports", order: 18 },
  { name: "Meet Harsoda", designation: "Sports Head", imageUrl: "/images/CoreTeam/Sports_committee/Meet_Harsoda_head.webp", department: "Sports", order: 19 },
  { name: "Dhyey Savaliya", designation: "Media Head", imageUrl: "/images/CoreTeam/Media_Cell/Heads/Dhyey_Savaliya.webp", department: "Media", order: 20 },
  { name: "Anmol Kumar", designation: "Media Head", imageUrl: "/images/CoreTeam/Media_Cell/Heads/Anmol_Kumar.webp", department: "Media", order: 21 },
  { name: "Satyam Ranjan", designation: "Content Head", imageUrl: "/images/CoreTeam/Content_Committee/Core/Satyam_Ranjan.webp", department: "Content", order: 22 },
]
